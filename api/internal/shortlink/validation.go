...
var queryKeys = map[string]map[string]struct{}{
	...
	"/recherche":           keys("theaters", "date", "start_after", "finish_before", "language", "format", "include_ads", "buffer_ads", "grouping", "layout", "selected", "selected_only", sharedTheatersKey),
