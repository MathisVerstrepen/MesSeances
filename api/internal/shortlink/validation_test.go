...
func TestValidTargetAcceptsSupportedRoutesAndQueries(t *testing.T) {
	for _, target := range []string{
		"/",
		"/planning?date=2026-08-22&language=ORIGINAL",
		"/recherche?date=2026-08-22&language=ORIGINAL",
		"/film/film-42?date=2026-08-22&language=ORIGINAL",
		"/planning?date=2026-08-22&language=VOF",
		"/recherche?date=2026-08-22&language=VOF",
		"/film/film-42?date=2026-08-22&language=VOF",
		...
		"/films?q=Am%C3%A9lie+Poulain&sort=title&page=2&genres=Com%C3%A9die%2CDrame&duration=medium&date=2026-08-22&date_to=2026-08-23&all_theaters=1",
		"/credits",
