...
func TestHistoryHTTPContract(t *testing.T) {
	...
	response := performRequest(t, handler, "/api/v1/statistics/history?date=0001-01-01&date_to=9999-12-31&city=lille&city=lyon&city=lille&genre=+DRAME+&language=VF_SME")
	...
	want := schedule.StatisticsQuery{Date: "0001-01-01", DateTo: "9999-12-31", City: []string{"lille", "lyon"}, Theater: []string{}, Genre: "drame", Language: "VF_SME"}
