...
func parseRoom(body []byte) string {
	...
	// Embedded JSON may itself be a JSON string. Decode only quote escapes;
	// never evaluate scripts or follow assets, forms, or meta refreshes.
...
// Rooms are optional facts. Only parent cancellation and provider blocks fail
// acquisition. Budget cancellation leaves unresolved rooms empty.
