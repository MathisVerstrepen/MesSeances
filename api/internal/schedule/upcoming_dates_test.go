...
func TestUpcomingReleaseWeek(t *testing.T) {
	for _, test := range []struct{ date, week string }{
		{"2026-09-16", "2026-09-16"}, {"2026-09-17", "2026-09-16"},
		{"2026-09-18", "2026-09-16"}, {"2026-09-19", "2026-09-16"},
		{"2026-09-20", "2026-09-16"}, {"2026-09-21", "2026-09-16"},
		{"2026-09-22", "2026-09-16"}, {"2026-09-23", "2026-09-23"},
		{"2026-10-01", "2026-09-30"}, {"2027-01-01", "2026-12-30"},
		{"2028-02-29", "2028-02-23"}, {"2028-03-01", "2028-03-01"},
		{"2026-03-29", "2026-03-25"}, {"2026-03-31", "2026-03-25"},
		{"2026-10-25", "2026-10-21"}, {"2026-10-27", "2026-10-21"},
	} {
		if got := upcomingReleaseWeek(test.date); got != test.week {
			t.Errorf("%s: week=%s want=%s", test.date, got, test.week)
		}
	}
}
