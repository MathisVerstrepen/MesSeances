...
func TestReviewSourceDetailURLs(t *testing.T) {
	for _, test := range []struct {
		...
		{"grandecran event", SourceGrandEcran, "cEvent_1", "G028P-" + strings.Repeat("a", 64), "G028P", "https://achat.grandecran.fr/test/r/123", "https://achat.grandecran.fr/test/r/123"},
		{"grandecran wrong cinema", SourceGrandEcran, "cEvent_1", "P9488-" + strings.Repeat("a", 64), "G028P", "https://achat.grandecran.fr/test/r/123", ""},
		{"grandecran unsafe booking", SourceGrandEcran, "cEvent_1", "G028P-" + strings.Repeat("a", 64), "G028P", "https://achat.grandecran.fr/test/r/123?redirect=elsewhere", ""},
		{"noecinemas event", SourceNoeCinemas, "cEvent_1", "P8088-" + strings.Repeat("a", 64), "P8088", "https://achat.cinema-laigle.com/reserver/r/123", "https://achat.cinema-laigle.com/reserver/r/123"},
		{"noecinemas wrong cinema", SourceNoeCinemas, "cEvent_1", "B0181-" + strings.Repeat("a", 64), "P8088", "https://achat.cinema-laigle.com/reserver/r/123", ""},
		{"noecinemas wrong host context", SourceNoeCinemas, "cEvent_1", "P8088-" + strings.Repeat("a", 64), "P8088", "https://achat.cinepal.fr/reserver/r/123", ""},
