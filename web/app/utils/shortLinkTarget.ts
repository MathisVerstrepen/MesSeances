...
const QUERY_KEYS = {
  ...
  '/recherche': new Set(['theaters', 'date', 'start_after', 'finish_before', 'language', 'format', 'include_ads', 'buffer_ads', 'grouping', 'layout', 'selected', 'selected_only', SHARED_THEATERS_KEY]),
  '/films': new Set(['q', 'sort', 'page', 'genres', 'duration', 'date', 'date_to', 'all_theaters', SHARED_THEATERS_KEY]),
