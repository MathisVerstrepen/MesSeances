...
export function youtubeNoCookieTrailerEmbedUrl(
...
export function availableTrailerSelections(
  vfValue: YouTubeKeyInput,
  voValue: YouTubeKeyInput,
): TrailerSelection[] {
  ...
  if (voKey && voKey !== vfKey)
    selections.push({ variant: 'VO', youtubeKey: voKey })
