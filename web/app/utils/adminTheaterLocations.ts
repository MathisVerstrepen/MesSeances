...
export function parseAdminTheaterLocationCoordinates(
  draft: AdminTheaterLocationCoordinateDraft,
): AdminTheaterLocationCoordinateValidation {
  ...
  if (!latitudeText) errors.latitude = 'Indiquez la latitude.'
    ...
    errors.latitude = 'Utilisez un nombre décimal valide.'
  ...
  if (!longitudeText) errors.longitude = 'Indiquez la longitude.'
    ...
    errors.longitude = 'Utilisez un nombre décimal valide.'
