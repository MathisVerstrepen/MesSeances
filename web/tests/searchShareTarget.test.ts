...
test('ORIGINAL survives complete and short-link sharing without expanding into concrete languages', () => {
  ...
  const target = buildCompleteSearchShareTarget({
    ...
    language: 'ORIGINAL', format: 'ALL', includeAds: false, bufferAds: 15,
