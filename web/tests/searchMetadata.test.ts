...
import { buildSearchMetaDescription, DEFAULT_SEARCH_DESCRIPTION } from '../app/utils/searchMetadata.ts'

test('describes complete shared search parameters', () => {
  assert.equal(buildSearchMetaDescription({
...
test('does not reflect malformed or incomplete query values into metadata', () => {
  for (const query of [
    {},
    { theaters: '<script>', date: '2026-09-21', start_after: '12:45', finish_before: '21:30' },
    { theaters: 'ugc-46', date: 'invalid', start_after: '12:45', finish_before: '21:30' },
    { theaters: 'ugc-46', date: '2026-09-21', start_after: ['12:45'], finish_before: '21:30' }
